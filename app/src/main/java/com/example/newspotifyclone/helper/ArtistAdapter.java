...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ViewHolder> {
    ...
    private ArrayList<ArtistModels.Artist> artistModelArrayList;
    private Context context;
    private ArtistInterface artistInterface;

    public ArtistAdapter(ArrayList<ArtistModels.Artist> artistModelArrayList, Context context, ArtistInterface artistInterface){
